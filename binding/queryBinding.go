...
var g = &grammar{
	rules: []*rule{
			...
			expr: &actionExpr{
				...
				expr: &seqExpr{
					...
					exprs: []interface{}{
						...
						&labeledExpr{
							...
							expr: &choiceExpr{
								...
								alternatives: []interface{}{
									...
									&ruleRefExpr{
										pos:  position{line: 38, col: 40, offset: 660},
										name: "Term",
									},
									&ruleRefExpr{
										pos:  position{line: 38, col: 47, offset: 667},
										name: "Expr",
									},
								},
							},
						...
						&ruleRefExpr{
							pos:  position{line: 38, col: 53, offset: 673},
							name: "_",
						},
					},
				},
		...
		{
			name: "Term",
			pos:  position{line: 42, col: 1, offset: 722},
			expr: &actionExpr{
				pos: position{line: 42, col: 9, offset: 730},
				...
				expr: &seqExpr{
					...
					exprs: []interface{}{
						...
						&oneOrMoreExpr{
							pos: position{line: 42, col: 11, offset: 732},
						...
						&ruleRefExpr{
							pos:  position{line: 42, col: 24, offset: 745},
							name: "_",
						},
					},
				},
		...
		},
		{
			...
			pos:         position{line: 47, col: 1, offset: 840},
			expr: &zeroOrMoreExpr{
				pos: position{line: 47, col: 19, offset: 858},
				expr: &charClassMatcher{
					pos:        position{line: 47, col: 19, offset: 858},
					val:        "[ \\n\\t\\r]",
					chars:      []rune{' ', '\n', '\t', '\r'},
		...
		{
			name: "EOF",
			pos:  position{line: 49, col: 1, offset: 870},
			expr: &notExpr{
				pos: position{line: 49, col: 8, offset: 877},
				expr: &anyMatcher{
					line: 49, col: 9, offset: 878,
				},
			},
		},
	},
